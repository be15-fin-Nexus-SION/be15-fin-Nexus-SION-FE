    ...
    <div class="w-full">
      <table class="min-w-full text-sm mt-4">
        ...
        <tr class="text-gray-500 border-b">
          ...
          <th class="p-2 text-center w-[10%]">유형</th>
          ...
          <th class="p-2 text-center w-[12%]">
            <SortDropdown
                ...
                :defaultValue="gradeOptions.find(opt => opt.value === gradeFilter)"
...
const roleLabel = (role) => {
  switch (role) {
    case 'INSIDER': return 'EMP';
    case 'OUTSIDER': return 'FREE';
...
watch([statusFilter, gradeFilter, sortBy, sortAsc, searchKeyword], fetchDevelopers);
</script>